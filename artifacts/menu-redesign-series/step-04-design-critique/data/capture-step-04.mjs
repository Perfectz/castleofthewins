...
const STEP_ROOT = path.join(ROOT, "artifacts", "menu-redesign-series", "step-04-design-critique");
...
if (!["before", "after"].includes(stage)) {
  console.error("Usage: node capture-step-04.mjs <before|after>");
  process.exit(1);
}
...
const FLOWS = [
  ["title", "Title", "Entry point hierarchy, CTA readability, and first-screen pacing."],
  ["creation", "Creation", "Commitment screen hierarchy and scanability."],
  ["town", "Town", "Live-play relationship to menu cues, chips, and dock actions."],
  ["run-menu", "Adventure Menu", "Primary hierarchy test for grouped actions and summaries."],
  ["pack", "Pack", "Dense inventory readability and section rhythm."],
  ["magic", "Magic", "Dense spell-management readability and section rhythm."],
  ["journal", "Run Journal", "Support-surface coherence and heading clarity."],
  ["help", "How to Play", "Reference-surface readability and section hierarchy."],
  ["settings", "Device Settings", "Control/settings readability and action hierarchy."]
];
