...
const STEP_DIR = path.join(ROOT, "artifacts", "menu-performance-series", "step-06-heavy-menu-hotspots");
...
async function installProfiler(page) {
  await page.evaluate(() => {
    ...
    const methodNames = [
      ...
      "getPackHubMarkup",
      "getInventoryGroupsMarkup",
      "getPackInspectorMarkup",
      "refreshMagicHubContent",
      "getMagicHubMarkup",
      "refreshJournalHubSection",
      "getJournalHubMarkup",
      "getJournalActiveSectionMarkup",
      "showShopModal",
      "updateShopModalPanel",
      "getShopModalBodyMarkup",
      "getShopPanelBodyMarkup"
    ];
